...
var SOLID_IDENTITY_PROVIDER = document.getElementById("solid_identity_provider").value;
...
async function login() {
  SOLID_IDENTITY_PROVIDER = document.getElementById("solid_identity_provider").value;
